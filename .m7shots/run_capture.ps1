# RiftReview M7 screenshot capture orchestration
...
# Adapted from .m6shots/run_capture.ps1 -- M7 only needs the deep-dive capture.
...
$shots     = "C:\Agent Projects\RiftReview\.m7shots"
...
Write-Host ""
Write-Host "=== M7 capture complete ==="
